...
## Hadoop installation
export HADOOP_HOME="${HADOOP_HOME:-/home/jeffreymanno/git/fluo-uno/install/hadoop-3.3.0}"
## Accumulo installation
export ACCUMULO_HOME="${ACCUMULO_HOME:-/home/jeffreymanno/git/fluo-uno/install/accumulo-2.1.0-SNAPSHOT}"
